        ...
        <div class="flex items-center space-x-4 relative">
          ...
          <div class="gap-4 flex items-center absolute right-4 top-0 bottom-0">
            ...
            <voice-recorder :disabled="!conversation"
                            ...
                            :user_id="user_id"
                            v-if="!textareaFocus"
                            class="text-xl text-gray-700 hover:text-orange-700 transition-colors text-white rounded-full flex justify-center items-center"></voice-recorder>

            <!-- Image Uploader Button -->
            <div v-if="!textareaFocus">
              <label class="cursor-pointer text-xl text-gray-700 hover:text-green-700 transition-colors text-white rounded-full flex justify-center items-center">
            ...
            <div v-if="!textareaFocus">
              <label class="cursor-pointer text-xl text-gray-700 hover:text-purple-700 transition-colors text-white rounded-full flex justify-center items-center">
            ...
            <div @click="send"
                 v-if="textareaFocus"
                 class="cursor-pointer text-xl text-gray-700 hover:text-blue-700 transition-colors text-white rounded-full flex justify-center items-center pl-0.5">
